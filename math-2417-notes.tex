...
\begin{practice}{\hyperref[ans:1.2.2-1]{1.2.2-1}}{Proving Limits via. $\varepsilon-\delta$ Definition}
    \label{prac:1.2.2-1}
...
\end{multicols}
\begin{practice}{\hyperref[ans:1.3.2-1]{1.3.2-1}}{Squeeze Theorem}\label{prac:1.3.2-1}
    Show that
    $\displaystyle\lim_{x\to 0}(\cos(\frac{2\pi}{3x})\cdot\sqrt{x^3+x^2})=0$
    using the Squeeze Theorem
\end{practice}
\begin{practice}{\hyperref[ans:1.3.2-2]{1.3.2-2}}{Trigonomic Limit}\label{prac:1.3.2-1}
    Evaluate:
...
\begin{practice}{\hyperref[ans:1.4-1]{1.4-1}}{Determine Continuity}\label{prac:1.4-1}
...
\begin{practice}{\hyperref[ans:1.4.1-1]{1.4.1-1}}{Intermediate Value Thorem}\label{prac:1.4.1-1}
...
\begin{practice}{\hyperref[ans:1.4.3-1]{1.4.3-1}}{Curveball Asymptote}\label{prac:1.4.3-1}
    Find the asymptotes:
    \begin{displaymath}
...
\begin{practice}{\hyperref[ans:1.4.3-2]{1.4.3-2}}{Curveball Trigonometry}\label{prac:1.4.3-2}
    Find the asymptotes:
    \begin{displaymath}
...
\begin{practice}{\hyperref[ans:2.1-1]{2.1-1}}{Finding the Tangent Line}\label{prac:2.1-1}
...
\begin{table}[h]
    ...
    \begin{center}
        \begin{tabular}{ |l|l| }
            ...
            \hline
            Trigonometry& $\frac{d}{dx}\sin(x)=\cos(x)$\\
...
\begin{practice}{\hyperref[ans:2.2-1]{2.2-1}}{Find Horizontal Tangents}
    \label{prac:2.2-1}
...
\begin{practice}{\hyperref[ans:2.3-1]{2.3-1}}{Velocity and Acceleration}
    \label{prac:2.3.1-1}
...
\begin{practice}{\hyperref[prac:2.4-1]{2.4-1}}{Tangent Lines and Circles}
    \label{prac:2.4-1}
    Find the slope of the tangent line at $(4,-3)$ of \textit{the circle}
    $$x^2+y^2=5^2$$
\end{practice}
...
\subsection*{\ref{prac:1.2.2-1}---Proving Limits via. $\varepsilon-\delta$ Definition}
\label{ans:1.2.2-1}
Consider $f(x)=10x-6$, prove that $\lim_{x\to 3}f(x)=24$ using the 
$\epsilon-\delta$ definition:
\br
...
\subsection*{\ref{prac:1.3.2-1}---Squeeze Theorem}\label{ans:1.3.2-1}
Show that
$\displaystyle\lim_{x\to 0}(\cos(\frac{2\pi}{3x})\cdot\sqrt{x^3+x^2})=0$
using the Squeeze Theorem
\br
...
\begin{align*}
    ...
    0&\leq\lim_{x\to 0}\cos(\frac{2\pi}{3x})&&\leq 0 
\end{align*}

Because of the Squeeze Theorem, $\displaystyle\lim_{x\to 0}\cos(\frac{2\pi}{3x})=0$

\subsection*{\ref{prac:1.3.2-1}---Trigonomic Limit}\label{ans:1.3.2-2}
Evaluate:
$$\lim_{x\to 0}\frac{\tan(3x)}{4x+\sin(2x)}$$
\br
...
\subsection*{\ref{prac:1.4-1}---Determine Continuity}\label{ans:1.4-1}
Determine if the function is continuous at $x=2$
...
\subsection*{\ref{prac:1.4.1-1}---Intermediate Value Theorem}\label{ans:1.4.1-1}
Use the Intermediate Value Theorem to prove that $x^3+x^2=1$ has at least
one solution on the interval $(-1, 2)$
\br
...
\subsection*{\ref{prac:1.4.3-1}---Curveball Asymptote}\label{ans:1.4.3-1}
Find the asymptotes:
\begin{displaymath}
    f(x)=\frac{\sqrt{(x-1)(x-3)}}{(x-2)(x-4)}
\end{displaymath}
...
\subsection*{\ref{prac:1.4.3-2}---Curveball Trigonometry}\label{ans:1.4.3-2}
Find the asymptotes:
\begin{displaymath}
    f(x)=\frac{\sin(x)}{x^3-x}
\end{displaymath}
...
\subsection*{\ref{prac:2.3.1-1}---Velocity and Acceleration}
A ball is thrown up into the air, and its position can be modeled into
...
it hits the ground is -10 $\displaystyle\frac{\text{ft}}{\text{s}^2}$
