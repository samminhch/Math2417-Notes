...
\begin{definition}{Critical Value}
    ...
    \newline$ $\newline % lmao i didn't know how to add a blank line lmaooo
...
that the inverse of the premise, and prove that it's a contradiction} with
\textit{Rolle's Theorem} to prove that
